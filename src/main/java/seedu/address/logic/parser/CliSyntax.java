...
public class CliSyntax {
    ...
    public static final Prefix PREFIX_LANGUAGE = new Prefix("ad/");
    public static final Prefix PREFIX_TIMES = new Prefix("t/");
