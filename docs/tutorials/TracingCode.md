...
Recall from the User Guide that the `edit` command has the format: `edit INDEX [n/NAME] [p/ISBN] [e/EMAIL] [a/ADDRESS] [t/CATEGORY]…​` For this tutorial we will be issuing the command `edit 1 n/Alice Yeoh`.
