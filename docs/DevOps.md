...
1. Get the Markdown code for the Codecov badge provided in `Settings > Badges` and update the `docs/index.md` of your repo with it so that the badge [![codecov](https://codecov.io/gh/se-edu/languagebook-level3/branch/master/graph/badge.svg)](https://codecov.io/gh/se-edu/languagebook-level3) in that page reflects the coverage of your project.
...
1. Update the version number in [`MainApp.java`](https://github.com/se-edu/languagebook-level3/tree/master/src/main/java/seedu/language/MainApp.java).
1. Generate a fat JAR file using Gradle (i.e., `gradlew shadow`).
1. Category the repo with the version number. e.g. `v0.1`
