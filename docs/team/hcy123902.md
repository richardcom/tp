...
* **Enhancements to existing features**:
  ...
  * Add attribute `Stocking`
    ...
    * Added the user interface component `LibraryBookDetailStockingCard`  to `Book` to show the stocking information with a book card that shows stocking related information of the book.
  ...
  * Add feature: add, delete, or edit the `Review ` in the review list of a book
