...
* **Contributions to the Team-Based Tasks**:
    ...
    * Opened Milestone v1.4 and managed the team project task in Milestone mid v1.3 and v1.4
    ...
    * Helped to solve technical issues regarding RepoSense contribution detection in week 12, and provided suggestion to use `git reset` to set the state of the upstream master branch.
